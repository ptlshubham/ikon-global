...
require './PHPMailer.php';
    ...
    $mail->Username   = 'info@ikonglobal.co';       // SMTP username
    $mail->Password   = "Ikong@123";                           // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 465;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
    
    $form_name = $_REQUEST['firstname'];
    ...
    //Recipients
    $mail->setFrom('info@ikonglobal.co', 'Contact Us');
    $mail->addAddress($contact_email, $form_name); 
    $mail->addAddress('info@ikonglobal.co', 'Contact Us'); 

    $servername = "127.0.0.1:3306";
    $username = "u768511311_ikonglobal";
    $password = "Rumit@2210";
    $database = "u768511311_ikonglobal";
    // Create connection
    ...
    $sql = "INSERT INTO `contact`(`email`, `name`, `subject`, `message`, `createddate`) VALUES
    ('$contact_email','.$form_name . $last_name.'$contact_subject', '$contact_message',CURRENT_TIMESTAMP);";
                                                             ...
                                                             <tr>
                                                                <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                                      <tbody>
                                                                         <tr>
                                                                            <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;width: 160px;" width="160"> <a href="http://metalvyapar.com/" target="_blank" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; padding: 0 10px;"> <img alt="Metalvyapar" height="auto" href="http://metalvyapar.com/" src="http://metalvyapar.com/img/logo-2.png" alt="Metalvyapar" border="0" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"> </a> </td>
                                                                         </tr>
                                                                      </tbody>
                                                                   </table>
                                                                </td>
                                                                ...
                                                                <tr>
                                                                   <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                      <div style="font-family:OpenSans, Helvetica, Tahoma, Arial, sans-serif;font-size:12px;font-weight:400;line-height:20px;text-align:center;color:#4F4F4F;">
                                                                         <br /> &copy; 2023 Metalvyapar. All rights reserved.
                                                                         <br />
                                                                      </div>
                                                                   </td>
                                                                </tr>
